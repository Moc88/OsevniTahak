...
namespace OsevniTahak.Controllers
{
    public class CropsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nazev,Odruda,Celed,Vyrobce,Trat")] Crop crop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nazev,Odruda,Celed,Vyrobce,Trat")] Crop crop)
        {
            if (id != crop.Id)
            {
                return NotFound();
